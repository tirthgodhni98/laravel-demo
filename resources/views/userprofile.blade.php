...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            ...
            <a class="btn btn-primary float-right mr-5" href="customerpanel">Back</a>
        ...
        <div class="col-md-6 ad" style="padding-bottom: 20px;">
                ...
                <form action="" method="post" name="shopform" enctype="multipart/form-data"  class="form-group addform"  style="text-align:center;">
                    ...
                    <div class="col-md-12 formpadding2">
                        ...
                        <span class=area>{{$user->email_id}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Fname :</span>
                        <span class=area style=" text-transform: capitalize;">{{$user->fname}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Lname :</span>
                        <span class=area style=" text-transform: capitalize;">{{$user->lname}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Gender :</span>
                        <span class=area style=" text-transform: capitalize;">{{$user->gender}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Phone No :</span>
                        <span class=area>{{$user->phone_no}}</span>
                    </div>
            ...
            <div class="col-md-6 ud" style="padding-bottom: 20px;">
                ...
                <form action="\update_user_profile" method="post"  class="form-group addform">
                    @csrf
                    <div class="col-md-12  formpadding2">
                    <input type="email" value="{{$user->email_id}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Email*" style="cursor: no-drop" disabled/>
                    </div>

                    <div class="col-md-12  formpadding2">
                        <input type="text" name="fname" value="{{$user->fname}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Fname*"/>
                    </div>

                    <div class="col-md-12  formpadding2">
                    <input type="text" name="lname" value="{{$user->lname}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Lname*"/>
                    </div>

                    <div class="formpadding2 col-md-12" style="text-align:center;">
                        <label>
                            <input type="radio" @if($user->gender == 'male') checked="checked" @endif name="gender" value="male" style="cursor: pointer;">
                            <i style="color: #aaa; font-weight: 500;">Male</i>&nbsp;&nbsp;
                            <input type="radio" name="gender" @if($user->gender == 'female') checked="checked" @endif name="gender" value="female" style="cursor: pointer;">
                            <i style="color: #aaa; font-weight: 500;">Female</i>
                        </label>
                    </div>

                    <div class="formpadding2 col-md-12">
                    <input type="text" name="phone_no" value="{{$user->phone_no}}" required="" pattern="^[0-9]*$" class="form-control area" placeholder="Enter Phone Number*"/>
                    </div>
                    ...
                    <div class="row">    
                        ...
                        <div class="col-md-6 btn ">
                        <a type="button" class="btn btn-primary" href="{{URL::to('userprofile')}}">
                                Cancle
                            </a>                                            
                        </div> 
                    </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    @endif
                        <form action="\update_user_password" method="post"  class="form-group">
                            @csrf
                            <div class="col-md-12  formpadding2">
