        ...
        <div class="col-md-6 ad" style="padding-bottom: 20px;">
                ...
                <form action="" method="post" name="shopform" enctype="multipart/form-data"  class="form-group addform"  style="text-align:center;">
                    ...
                    <div class="col-md-12 formpadding2">
                        ...
                        <span class=area>{{$admin->email_id}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Fname :</span>
                        <span class=area style=" text-transform: capitalize;">{{$admin->fname}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Lname :</span>
                        <span class=area style=" text-transform: capitalize;">{{$admin->lname}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Gender :</span>
                        <span class=area style=" text-transform: capitalize;">{{$admin->gender}}</span>
                    </div>

                    <div class="col-md-12 formpadding2">
                        <span class=area>Phone No :</span>
                        <span class=area>{{$admin->phone_no}}</span>
                    </div>
            ...
            <div class="col-md-6 ud" style="padding-bottom: 20px;">
                ...
                <form action="\update_profile" method="post"  class="form-group addform">
                    @csrf
                    <div class="col-md-12  formpadding2">
                    <input type="email" value="{{$admin->email_id}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Email*" style="cursor: no-drop" disabled/>
                    </div>

                    <div class="col-md-12  formpadding2">
                        <input type="text" name="fname" value="{{$admin->fname}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Fname*"/>
                    </div>

                    <div class="col-md-12  formpadding2">
                    <input type="text" name="lname" value="{{$admin->lname}}" required="" pattern="^[a-zA-Z ]*$" class="form-control area" placeholder="Enter Lname*"/>
                    </div>

                    <div class="formpadding2 col-md-12" style="text-align:center;">
                        <label>
                            <input type="radio" @if($admin->gender == 'male') checked="checked" @endif name="gender" value="male" style="cursor: pointer;">
                            <i style="color: #aaa; font-weight: 500;">Male</i>&nbsp;&nbsp;
                            <input type="radio" name="gender" @if($admin->gender == 'female') checked="checked" @endif name="gender" value="female" style="cursor: pointer;">
                            <i style="color: #aaa; font-weight: 500;">Female</i>
                        </label>
                    </div>

                    <div class="formpadding2 col-md-12">
                    <input type="text" name="phone_no" value="{{$admin->phone_no}}" required="" pattern="^[0-9]*$" class="form-control area" placeholder="Enter Phone Number*"/>
                    </div>
                    ...
                    <div class="row">    
                        ...
                        <div class="col-md-6 btn ">
                        <a type="button" class="btn btn-primary" href="{{URL::to('adminprofile')}}">
                                Cancle
                            </a>                                            
                        </div> 
                    </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    @endif
                        <form action="\update_password" method="post"  class="form-group">
                            @csrf
                            <div class="col-md-12  formpadding2">
