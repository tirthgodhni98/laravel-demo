        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="btn btn-primary float-right mr-5" href="hostpanel">Back</a>
                    <h2>Display  <span class="colorextra">Cancle Booking</span></h2>
                    <!-- <hr> -->
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="contact2-title text-center mb-65 formpad">
                        <!-- <h2><span class="colorextra">Manage Booking</span></h2><br/> -->
                    </div>
                        <table class="table table-striped" style="text-align:center;">
                            ...
                            @endforeach
                            <tr>
                                <td style=" text-transform: capitalize;">Total Cancel Bookings:- {{ $booking_data->Total()}} </td>
